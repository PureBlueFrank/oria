...
_WRITE_ACTION_ROLES: dict[str, frozenset[str]] = {
    ...
    "approval:assortment:request": frozenset({"campaign_admin"}),
    "approval:assortment:decide": frozenset({"assortment_approver"}),
    ...
    "approval:notification:request": frozenset({"campaign_admin"}),
    "approval:notification:decide": frozenset({"notification_approver"}),
