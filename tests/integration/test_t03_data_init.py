...
async def test_two_empty_databases_upgrade_seed_and_repeat_idempotently(tmp_path: Path) -> None:
    ...
    assert first.business_revision == second.business_revision == "business_0004"
    ...
    assert _revision(config.data_paths.business_db, "alembic_version_business") == "business_0004"
