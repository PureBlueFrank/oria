...
[![场景 A：招商活动 10 步工作流](../diagrams/scenario-a-workflow.visual-check.1440x900.light.png)](https://purebluefrank.github.io/oria/diagrams/scenario-a-workflow.html)

[打开在线交互工作流图](https://purebluefrank.github.io/oria/diagrams/scenario-a-workflow.html) · [查看可维护 JSON 图源](../diagrams/scenario-a-workflow.workflow.json)
