...
**门禁状态**：P0–P2 已完成，本轮演示与证据验收门禁关闭。V0.5 仍为未开始；后续启动须另行按既有 `Depends on` 顺序执行，V0.6 等待 V0.5 完成，V0.7、V0.8 继续依次推进。
